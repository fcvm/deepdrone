...
#         Import Error: Gurobi
# - FURTHER PAPER IMPLEMENTATION [ ]
#         Optimal keyframe times
#         Corridor constrains
#         Normalized time
#         Nondimensional coordinates
#         ...
# - MINIMUM JERK TRAJECTORY IMPLEMENTATION [ ]
# - ROUNDS PARAMETER
...
import cvxopt # https://scaron.info/blog/quadratic-programming-in-python.html
import gurobipy
...
'____ GUROBI WRAPPER ____'

def Gurobi_SolveQPMatrixNotation(
        obj_mat, 
        obj_vec=None, 
        ine_mat=None, 
        ine_vec=None, 
...
'____ TRAJECTORY CLASS ____'

class Trajectory():
    # This class computes a trajectory from keyframes as input.
    # Current implemented methods: 
    #   - minimum snap trajectory

    @staticmethod
    def Debug( rounds=False, method='min_snap', ord_poly=6, solver='gurobi' ):
        # This static method is for quick testing and debugging.
        ...
        if rounds == False:
            t = np.array([      0,      1.0,    2,          3,      4,      5,      6,      7       ] , dtype=np.float64)
        # *** \INPUTS  ***
    ...
    def MinSnapTraj(self, ord_poly=6, solver='gurobi'):
        # Ressource ?????
        # Explanation ?????????
