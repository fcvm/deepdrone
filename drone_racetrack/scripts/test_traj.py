...
if __name__=="__main__":
	bag = rosbag.Bag('/home/yanlong/extra_ws/src/offb_py/src/scripts/report/test_{}.bag'.format(time.strftime("%Y-%m-%d %H:%M:%S",time.localtime())), 'w')
	bag2 = rosbag.Bag('/home/yanlong/extra_ws/src/offb_py/src/scripts/report/test2_{}.bag'.format(time.strftime("%Y-%m-%d %H:%M:%S",time.localtime())), 'w')
	bag3 = rosbag.Bag('/home/yanlong/extra_ws/src/offb_py/src/scripts/report/test3_{}.bag'.format(time.strftime("%Y-%m-%d %H:%M:%S",time.localtime())), 'w')
	bag4 = rosbag.Bag('/home/yanlong/extra_ws/src/offb_py/src/scripts/report/test4_{}.bag'.format(time.strftime("%Y-%m-%d %H:%M:%S",time.localtime())), 'w')
	global current_state
	global recordflag
	...
	A2 = jtraj(q1, q2, tv, qd0=None, qd1=None)
	A3 = jtraj(q2, q3, tv, qd0=None, qd1=None)
