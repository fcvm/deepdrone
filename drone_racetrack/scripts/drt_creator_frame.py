...
class DRT_CreatorFrame(
    ...
    def __init__( self, Master ):
        ...
        # Initialize GUI
        sh = int( 0.8 * Master.winfo_screenheight() )
        print("\n\n\n", sh, "\n\n\n")
        self.drt_creator_frame = tk.Frame(Master)
        self.drt_creator_frame.pack(side=tk.LEFT)

        DRT_DirectionFrame.__init__(self, self.drt_creator_frame, sh)
        DRT_SlopeFrame.__init__(self, self.drt_creator_frame, sh)
        DRT_BuildFrame.__init__(self, self.drt_creator_frame, sh)
        DRT_WreckFrame.__init__(self, self.drt_creator_frame, sh)
        DRT_ParameterFrame.__init__(self, self.drt_creator_frame)
        DRT_TrajectoryFrame.__init__(self, self.drt_creator_frame, sh)
