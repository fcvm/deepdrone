...
\AddToShipoutPicture*{%
  \put(.5\paperwidth,.5\paperheight)% center of the page 
    {\makebox(0,0){\transparent{0.1}\includegraphics[scale=0.4]{Figures/watermark/Tsinghua_University_Logo.png}}}%
}
...
\emph{Author:}\\
\href{https://www.researchgate.net/profile/Friedrich_Mangelsdorf2}{\authorname} % Author name - remove the \href bracket to remove the link
\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.4\textwidth}
\begin{flushright} \large
\emph{Supervisor:} \\
\href{https://www.tsinghua.edu.cn/publish/jxxen/4192/2014/20141108161735859474060/20141108161735859474060_.html}{\supname} % Supervisor name - remove the \href bracket to remove the link  
\end{flushright}
\end{minipage}\\[3cm]
