...
%, e.g. business-to-customer delivery.
...
\subsection{Classification by Technical Specifications}
...
e.g. US. Department of Defense %https://web.archive.org/web/20160121155841/http://www.acq.osd.mil/sts/docs/DoD_UAS_Airspace_Integ_Plan_v2_(signed).pdf
)
...
\begin{table}
    ...
    \toprule
    \tabhead{Class} & \tabhead{Airframe Size} & \tabhead{Aircraft Weight} & \tabhead{Flight Level} & \tabhead{Flight Endurance} & \tabhead{Communication Range} & \tabhead{Infrastructure} \\
    \midrule
...
UAVs are not only classified by airframe type
